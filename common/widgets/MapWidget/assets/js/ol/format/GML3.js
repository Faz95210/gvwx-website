...
import {
    createElementNS, getAllTextContent, makeArrayPusher, makeChildAppender,
    makeReplacer, makeSimpleNodeFactory, OBJECT_PROPERTY_NODE_FACTORY, parseNode,
    pushParseAndPop, pushSerializeAndPop, XML_SCHEMA_INSTANCE_URI
} from '../xml.js';
...
class GML3 extends GMLBase {
    ...
    writeGeometryNode(geometry, opt_options) {
        ...
        const context = {
            node: geom, hasZ: this.hasZ, srsName: this.srsName,
