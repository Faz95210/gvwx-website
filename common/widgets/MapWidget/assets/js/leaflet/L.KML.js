L.KML = L.FeatureGroup.extend({
    ...
    _addKML: function (xml) {
        ...
        this._documentName = layers._name;
        this._options = layers[0]['options'];
        this.fire('loaded');
    },
...
L.Util.extend(L.KML, {
    ...
    parseLineString: function (line, xml, options) {
        ...
        options['maxMarkers'] = 10;
        const polyline = new L.Polyline(coords, options);
    ...
    getDocumentName: function (xml) {
        const el = xml.getElementsByTagName('Document')[0].getElementsByTagName('name');
