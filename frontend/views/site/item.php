    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <?= Html::input('date', 'date_mandat', ($this->params['item']->date_mandat ? date("Y-m-d", $this->params['item']->date_mandat) : ''), ['id' => 'mandat-input', 'class' => 'col-sm-9 col-form-label form-control']) ?>
            </div>
            <div class="form-group row">
